                ...
                <div className="lg:bg-[url('/svg/heroimage.svg')] bg-[url('/svg/mobilehero.svg')] md:bg-[url('/svg/herotablet.svg')] bg-no-repeat bg-cover pt-40 lg:mb-28 mb-20 bg-black">
                    <div className="lg:max-w-7xl lg:mx-auto mx-6 md:mx-10">
                        <div className="flex flex-col items-center">
                            <h1 className="lg:text-5xl md:text-5xl text-3xl font-medium font-ubuntu text-white text-center lg:leading-normal md:leading-normal lg:w-5/6">Your Trusted Partner in Innovation</h1>
                            <p className="text-white text-center lg:mt-4 mt-6 mb-28 lg:w-4/5 font-ubuntu leading-loose md:leading-normal text-sm md:text-base">Delivering Comprehensive IT Solutions, Goods, and Services Across 88 Cities in Indonesia with Excellence and Reliability.</p>
                        </div>
                    </div>
                    ...
                    <div className="lg:grid lg:grid-cols-4 lg:gap-4 gap-2 grid grid-cols-2">
                        {
                            dynamicArr.length == 0
                                ...
                                dynamicArr.map((product: any) => (
                                    <div key={product.id} className="bg-[#F5F5F5] lg:px-6 px-3 lg:py-6 py-4 flex flex-col items-center">
                                        <Image src={product.src} alt="" />
                                        <h1 className="font-ubuntu font-normal lg:text-xl text-sm mt-3 mb-2 text-center">{product.title}</h1>
                                        ...
                                        <div className="flex lg:gap-4 gap-2">
                                            <Link href={product.topedLink} className="border-[#409442] rounded-full border-2 lg:w-12 lg:h-12 md:w-12 md:h-12 w-11 h-11 px-2.5 py-2.5 flex hover:bg-[#40944146]">
                                                <Image
                                                    alt={product.alt}
                                                    src={tokped}
                                                />
                                            </Link>
                                            <Link href={product.shopeeLink} className="border-[#EE4D2D] rounded-full border-2 lg:w-12 lg:h-12 md:w-12 md:h-12 w-11 h-11 px-2.5 py-2.5 flex hover:bg-[#ee4d2d2c]">
                                                <Image
                                                    alt={product.alt}
                                                    src={shopee}
                                                />
                                            </Link>
                                            <Link href={product.tiktokLink} className="border-black rounded-full border-2 lg:w-12 lg:h-12 md:w-12 md:h-12 w-11 h-11 px-2.5 py-2.5 flex hover:bg-[#0000002a]">
                                                <Image
                                                    alt={product.alt}
                                                    src={tiktok}
                                                    className=""
