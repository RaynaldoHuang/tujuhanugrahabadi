        ...
        <>
            <div>
                <div className="bg-[#062236]">
                    <div className="lg:pt-16 pt-12 lg:max-w-8xl lg:mx-auto mx-6">
                        <div>
                                ...
                                <div>
                                    ...
                                    <div className="flex-col">
                                        <div className="flex mt-10">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" className="lg:size-8 size-20">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                                            </svg>
                                            <p className="text-white font-ubuntu lg:w-2/3 ms-3 lg:text-base text-sm">Ruko G-Walk Citraland, Jl. Ruko Taman Gapura Blok W2 No.32, Lontar, Kec. Sambikerep, Kota Surabaya, Jawa Timur 60217 <br />(031) 57431015
                                            </p>
                                        </div>
                                    </div>

                                    <div className="flex mt-8">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" className="lg:size-8 size-14">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                                        </svg>
                                        <p className="text-white font-ubuntu lg:w-2/3 ms-3 lg:text-base text-sm">Jl. Kebon Jeruk VII No.2A, RT.4/RW.5, Maphar, Kec. Taman Sari, Jakarta, Jawa Barat 11160<br />(021) 22683226</p>
                                    </div>
                                </div>

                                <div className="flex lg:grid lg:grid-cols-2 lg:gap-12 gap-12 mt-10 lg:mt-0">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="mt-7 gap-y-4 items-center font-ubuntu">
                                            ...
                                            <div className="flex">
                                                <Image src={instagram} alt="" className="me-3 w-6 lg:w-7" />
